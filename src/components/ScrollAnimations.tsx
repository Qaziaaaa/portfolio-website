    ...
    const initDesktop = () => {
      ...
      sections.forEach((section) => {
        ...
        if (id === 'hero') {
          ...
          const socialLinks = section.querySelectorAll('.inline-flex a, a[aria-label]')
        ...
        if (id === 'projects') {
          ...
          const rows = section.querySelectorAll('.md\\:grid')
          rows.forEach((row) => {
        ...
        if (id === 'contact') {
          const heading = section.querySelector('h2')
          const lines = section.querySelectorAll('p, .text-2xl, .text-lg')
