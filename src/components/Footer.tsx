      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-20">
        <div className="border-t border-zinc-800 pt-16 pb-8">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12">
            ...
            <div className="flex flex-col md:items-end gap-6">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://github.com/Qaziaaaa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-zinc-700 flex items-center justify-center hover:border-white transition-colors group">
          ...
          <div className="border-t border-zinc-800 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-zinc-600 text-sm">&copy; {year} Qazi Farhan. All rights reserved.</p>
            <p className="text-zinc-600 text-sm">Peshawar, Pakistan</p>
          </div>
        </div>
      </div>
    </footer>
