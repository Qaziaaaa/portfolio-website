...
export default function Skills() {
  return (
    <section className="pt-10" id="skills">
      ...
      <div className="self-stretch overflow-hidden flex flex-col py-0 md:pb-20 px-8 gap-[20px]">
        <div className="self-stretch grid grid-cols-2 md:flex md:flex-row md:flex-wrap justify-items-center md:items-center md:justify-center py-5 box-border gap-[10px] md:gap-[71px] min-h-[492px] text-center text-xl">
          {skills.map((skill, i) => (
            <div key={i} className="h-[145px] w-[145px] md:h-[186px] md:w-[186px] rounded bg-white box-border border-black flex flex-col items-center justify-center py-6 px-[22px] gap-[32px] border-[2px] border-solid border-black">
