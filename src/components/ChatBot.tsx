    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-black text-white flex items-center justify-center shadow-lg hover:scale-105 transition-transform active:scale-95"
      ...
      {open && (
        <div className="fixed bottom-6 right-6 z-[60] w-80 sm:w-96 h-[500px] max-h-[calc(100dvh-100px)] bg-white border-2 border-black rounded-xl shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 fade-in duration-200">
